...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>إدارة المخازن والمبيعات</title>
...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-btc"></i> العلامات التجارية</a></li>        

        <li id="navCategories"><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> الأصناف</a></li>        
