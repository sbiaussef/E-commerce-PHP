...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  إدارة الطلبات
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i>  تعديل طلب
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label"> إسم العميل</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder=" إسم العميل" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label"> التواصل مع العميل</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder=" رقم التواصل" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">إسم المنتج </th>
			  			<th style="width:20%;">سعر المنتج</th>
			  			<th style="width:15%;">الكمية المطلوبة</th>			  			
			  			<th style="width:15%;">الإجمالى</th>			  			
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label"> سعر الكمية</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label"> النسبة المضافة</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label"> أجمالى السعر </label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label"> السعر بعد الخصم</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label"> المبلغ المتبقى</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	...
				      	<option value="2"> دفع مقدماً</option>
				      	<option value="3"> لم يتم الدفع بالكامل</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
			  </div> <!--/col-md-6-->
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i>  إضافة صف جديد </button>
			      ...
			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> إستعادة</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label"> وسيلة الدفع</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType" >
				      	<option value="">أختار</option>
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i>  حفظ</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentStatus" id="paymentStatus">
			      	<option value="">أختار</option>
			      	<option value="1"> الدفع كامل</option>
			      	<option value="2"> الدفع مقدماً</option>
			      	<option value="3">لم يتم الدفع بالكامل</option>
			      </select>
			    </div>
			  </div> <!--/form-group-->							  				  
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePaymentOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> حفظ</button>	
      </div>           
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>هل تريد بالفعل حذف الطلب ؟</p>
      </div>
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> إغلاق</button>
        <button type="button" class="btn btn-primary" id="removeOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i>  حفظ</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
