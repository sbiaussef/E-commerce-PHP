$(document).ready(function() {
	...
	$("#changeUsernameForm").unbind('submit').bind('submit', function() {
		...
		if(username == "") {
			$("#username").after('<p class="text-danger">يجب إدخال أسم المستخدم</p>');
	...
	$("#changePasswordForm").unbind('submit').bind('submit', function() {
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			if(currentPassword == "") {
				$("#password").after('<p class="text-danger">يجب إدخال كلمة المرور الحالية</p>');
			...
			if(newPassword == "") {
				$("#npassword").after('<p class="text-danger">يجب إدخال كلمة المرور الجديدة</p>');
			...
			if(conformPassword == "") {
				$("#cpassword").after('<p class="text-danger">يجب تأكيد كلمة المرور</p>');
