...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productImage == "") {
				$("#productImage").closest('.center-block').after('<p class="text-danger">يجب أختيار صورة المنتج</p>');
			...
			if(productName == "") {
				$("#productName").after('<p class="text-danger">يجب إدخال أسم المنتج</p>');
			...
			if(quantity == "") {
				$("#quantity").after('<p class="text-danger">يجب إدخال الكمية المتاحة</p>');
			...
			if(rate == "") {
				$("#rate").after('<p class="text-danger">يجب إدخال السعر</p>');
			...
			if(brandName == "") {
				$("#brandName").after('<p class="text-danger">يجب تحديد العلامة التجارية</p>');
			...
			if(categoryName == "") {
				$("#categoryName").after('<p class="text-danger">يجب تحديد الصنف </p>');
			...
			if(productStatus == "") {
				$("#productStatus").after('<p class="text-danger">يجب تحديد الحالة</p>');
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(productName == "") {
						$("#editProductName").after('<p class="text-danger">يجب إدخال أسم المنتج</p>');
					...
					if(quantity == "") {
						$("#editQuantity").after('<p class="text-danger">يجب إدخال الكمية المتاحة</p>');
					...
					if(rate == "") {
						$("#editRate").after('<p class="text-danger">يجب إدخال السعر</p>');
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">يجب تحديد العلامة التجارية</p>');
					...
					if(categoryName == "") {
						$("#editCategoryName").after('<p class="text-danger">يجب تحديد الصنف</p>');
					...
					if(productStatus == "") {
						$("#editProductStatus").after('<p class="text-danger">يجب تحديد الحالة</p>');
				...
				$("#updateProductImageForm").unbind('submit').bind('submit', function() {					
					...
					if(productImage == "") {
						$("#editProductImage").closest('.center-block').after('<p class="text-danger">يجب إختيار الصورة</p>');
