...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandName == "") {
			$("#brandName").after('<p class="text-danger">يجب إدخال إسم العلامة التجارية</p>');
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">يجب تحديد الحالة  </p>');
...
function editBrands(brandId = null) {
	if(brandId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">يجب إدخال أسم العلامة التجارية</p>');
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">يجب تحديد الحالة  </p>');
		...
		alert('خطأ !! قم بتحديث الصفحة مرة أخرى');
	}
